...
public final class FragmentDataBinding implements ViewBinding {
  ...
  private FragmentDataBinding(@NonNull LinearLayout rootView, @NonNull TextView descriptionTextView,
  ...
  public static FragmentDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDataBinding((LinearLayout) rootView, descriptionTextView, imageView,
          titleTextView);
    }
